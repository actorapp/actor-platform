...
public class ResponsePublicKeys extends Response {
    ...
    private List<ApiEncryptionPublicKey> publicKey;

    public ResponsePublicKeys(@NotNull List<ApiEncryptionPublicKey> publicKey) {
    ...
    @NotNull
    public List<ApiEncryptionPublicKey> getPublicKey() {
        return this.publicKey;
    }

    @Override
    public void parse(BserValues values) throws IOException {
        List<ApiEncryptionPublicKey> _publicKey = new ArrayList<ApiEncryptionPublicKey>();
        for (int i = 0; i < values.getRepeatedCount(1); i++) {
            _publicKey.add(new ApiEncryptionPublicKey());
        }
