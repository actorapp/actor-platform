...
public class RequestUploadEphermalKey extends Request<ResponseVoid> {

    public static final int HEADER = 0xa34;
    public static RequestUploadEphermalKey fromBytes(byte[] data) throws IOException {
        return Bser.parse(new RequestUploadEphermalKey(), data);
    }
    ...
    public RequestUploadEphermalKey(int keyGroupId, @NotNull List<ApiEncryptionKey> keys, @NotNull List<ApiEncryptionKeySignature> signatures) {
        this.keyGroupId = keyGroupId;
        this.keys = keys;
        this.signatures = signatures;
    }

    public RequestUploadEphermalKey() {
    ...
    public String toString() {
        String res = "rpc UploadEphermalKey{";
