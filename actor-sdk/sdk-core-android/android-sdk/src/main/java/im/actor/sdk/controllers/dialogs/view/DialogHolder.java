...
public class DialogHolder extends BindedViewHolder {
    ...
    public DialogHolder(Context context, DialogView dialogView, final OnItemClickedListener<Dialog> onClickListener) {
        super(dialogView);
...
//            backgroundColorDrawable = new ColorDrawable(style.getMainBackgroundColor());
//        }
//        if (dividerColorDrawable == null) {
//            dividerColorDrawable = new ColorDrawable(style.getDividerColor());
//            divSize = context.getResources().getDimensionPixelSize(R.dimen.div_size);
//        }
...
//        {
//            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, Screen.dp(19 + 4));
//            // params.weight = 1;
...
//
//        separator = new DividerView(context);
//        FrameLayout.LayoutParams divLayoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
