export default {
  ...
  'messages': {
    ...
    'message': {
      ...
      'uploading': 'Загрузка...',
      'welcome': {
        'private': '<p>Это начало вашей беседы с <strong>{name}</strong>.</p>' +
                   '<p>Сообщения доступны только вам двоим.</p>',
        'group': {
    ...
    'modal': {
      'profile': {
        ...
        errors: {
          nick: {
            ...
            chars: 'Используйте латинские буквы, цифры и подчеркивание'
          }
        }
      },
      'group': {
      ...
      'confirm': {
        ...
        'user': {
          ...
          'removeContact': 'Вы действительно хотите удалить {name} из списка контактов?'
        },
        'group': {
          ...
          'kick': 'Вы действительно хотите исключить {name} из диалога?'
        },
        'nonContactHide': {
          'title': 'Вы действительно хотите скрыть этот диалог?',
          'body': '{name} нет в списке ваших контактов.'
        },
    ...
    'integrationTokenHint': 'Используйте этот токен для настройки интеграции с вашими системами.',
    ...
    'main': {
      'empty': 'Старайся быть лучше, чем вчера!',
      'deactivated': {
        'header': 'Вкладка деактивирована',
        'text': 'Упс! Похоже, вы открыли еще одну вкладку {appName}. Мы деактивируем эту вкладку, чтобы избежать ошибок.'
      }
    },
    ...
    invite: {
      ...
      byLink: {
        ...
        description: 'Любой в интернете присоединится к «<b>{groupName}</b>», пройдя по этой ссылке:',
        copy: 'Скопировать',
        revoke: 'Отменить'
      }
    },
