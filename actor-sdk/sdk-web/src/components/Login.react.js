        ...
        <div className="login-new__welcome col-xs row center-xs middle-xs">
          ...
          <article>
            <h1 className="login-new__heading">
              <FormattedHTMLMessage id="login.welcome.heading"/>
            </h1>

            <FormattedHTMLMessage id="login.welcome.text"/>
          </article>

          <footer>
            <div className="pull-left"><FormattedMessage id="login.welcome.copyright"/></div>
