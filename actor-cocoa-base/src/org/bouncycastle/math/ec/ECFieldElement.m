...
//  source: /Users/ex3ndr/Develop/actor-model/actor-ios/build/java/org/bouncycastle/math/ec/ECFieldElement.java
//
...
- (instancetype)initWithJavaMathBigInteger:(JavaMathBigInteger *)q
  ...
  return [self initOrgBouncycastleMathEcECFieldElement_FpWithJavaMathBigInteger:q withJavaMathBigInteger:OrgBouncycastleMathEcECFieldElement_Fp_calculateResidueWithJavaMathBigInteger_(q) withJavaMathBigInteger:x];
}
...
- (instancetype)initWithJavaMathBigInteger:(JavaMathBigInteger *)q
                    withJavaMathBigInteger:(JavaMathBigInteger *)r
                    withJavaMathBigInteger:(JavaMathBigInteger *)x {
  return [self initOrgBouncycastleMathEcECFieldElement_FpWithJavaMathBigInteger:q withJavaMathBigInteger:r withJavaMathBigInteger:x];
}
...
- (instancetype)initOrgBouncycastleMathEcECFieldElement_F2mWithInt:(jint)m
  ...
  if (self = [super init]) {
    if ((k2 == 0) && (k3 == 0)) {
      ...
      if (k2 >= k3) {
        @throw [[JavaLangIllegalArgumentException alloc] initWithNSString:@"k2 must be smaller than k3"];
      }
      if (k2 <= 0) {
        @throw [[JavaLangIllegalArgumentException alloc] initWithNSString:@"k2 must be larger than 0"];
      }
...
- (instancetype)initWithInt:(jint)m
                    ...
                    withInt:(jint)k3
     withJavaMathBigInteger:(JavaMathBigInteger *)x {
  return [self initOrgBouncycastleMathEcECFieldElement_F2mWithInt:m withInt:k1 withInt:k2 withInt:k3 withJavaMathBigInteger:x];
}

- (instancetype)initWithInt:(jint)m
                    withInt:(jint)k
     withJavaMathBigInteger:(JavaMathBigInteger *)x {
  return [self initOrgBouncycastleMathEcECFieldElement_F2mWithInt:m withInt:k withInt:0 withInt:0 withJavaMathBigInteger:x];
}
