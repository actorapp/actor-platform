...
public class RequestGetAdBanners extends Request<ResponseGetAdBanners> {
    ...
    public void parse(BserValues values) throws IOException {
        this.maxBannerWidth = values.getInt(1);
        this.maxBannerHeight = values.getInt(2);
        this.screenDensity = values.getDouble(3);
    }

    @Override
    public void serialize(BserWriter writer) throws IOException {
        writer.writeInt(1, this.maxBannerWidth);
        writer.writeInt(2, this.maxBannerHeight);
        writer.writeDouble(3, this.screenDensity);
    }
