...
public class JavaNewTcpConnection implements Connection {
    ...
    // private static final int HEADER_INTERNAL_ERROR = 5;
    ...
    public JavaNewTcpConnection(int id, ConnectionEndpoint endpoint, ConnectionCallback callback) throws IOException {
        this.id = id;
        ...
        handshakeRequest.writeByte(1); // MTProto Version
        handshakeRequest.writeByte(1); // Api Major Version
        handshakeRequest.writeByte(0); // Api Minor Version
