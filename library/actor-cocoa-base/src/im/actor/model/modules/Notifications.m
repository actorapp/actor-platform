...
- (void)run {
  self->notificationsActor_ = [((DKActorSystem *) nil_chk(DKActorSystem_system())) actorOfWithDKProps:DKProps_createWithIOSClass_withDKActorCreator_(ImActorModelModulesNotificationsNotificationsActor_class_(), [[ImActorModelModulesNotifications_$1 alloc] initWithImActorModelModulesNotifications:self]) withNSString:@"actor/notifications"];
}
