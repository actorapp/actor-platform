...
#line 65
  *IOSIntArray_GetRef(nil_chk(X_), xOff_++) = (IOSByteArray_Get(nil_chk(inArg), inOff) & (jint) 0xff) | (LShift32((IOSByteArray_Get(inArg, inOff + 1) & (jint) 0xff), 8)) |
#line 66
  (LShift32((IOSByteArray_Get(inArg, inOff + 2) & (jint) 0xff), 16)) | (LShift32((IOSByteArray_Get(inArg, inOff + 3) & (jint) 0xff), 24));
