...
public class ConversationVM {
    ...
    public ConversationVM(final Peer peer, final ConversationVMCallback callback, final Modules modules) {
        this.displayList = modules.getDisplayLists().getMessagesGlobalList(peer);
