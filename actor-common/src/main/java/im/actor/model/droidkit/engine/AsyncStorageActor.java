...
class AsyncStorageActor<T extends BserObject & ListEngineItem> extends Actor {
    ...
    public AsyncStorageActor(ListStorage storage, BserCreator<T> creator) {
    ...
    public void loadForward(String query, Long topSortKey, int limit, ListEngineCallback<T> callback) {
        ArrayList<T> res;
    ...
    public void loadBackward(String query, Long topSortKey, int limit, ListEngineCallback<T> callback) {
        ArrayList<T> res;
    ...
    public static class LoadForward<T extends BserObject & ListEngineItem> {
        ...
        private int limit;
        private ListEngineCallback<T> callback;

        public LoadForward(String query, Long topSortKey, int limit, ListEngineCallback<T> callback) {
            this.query = query;
        ...
        public ListEngineCallback<T> getCallback() {
            return callback;
        }
    }
    ...
    public static class LoadBackward<T extends BserObject & ListEngineItem> {
        ...
        public LoadBackward(String query, Long topSortKey, int limit, ListEngineCallback<T> callback) {
            this.query = query;
            this.topSortKey = topSortKey;
            this.limit = limit;
            this.callback = callback;
