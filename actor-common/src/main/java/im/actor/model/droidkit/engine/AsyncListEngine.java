...
public class AsyncListEngine<T extends BserObject & ListEngineItem>
    ...
    public AsyncListEngine(ListStorage storage, BserCreator<T> creator) {
        this.asyncStorageInt = new AsyncStorageInt(storage, creator);
    }
    ...
    @Override
    public void loadForward(String query, long afterSortKey, int limit, final ListEngineCallback<T> callback) {
    ...
    private ListEngineCallback<T> cover(final ListEngineCallback<T> callback) {
