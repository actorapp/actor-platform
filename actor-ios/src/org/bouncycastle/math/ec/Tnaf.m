...
+ (void)initialize {
  if (self == [OrgBouncycastleMathEcTnaf class]) {
    ...
    OrgBouncycastleMathEcTnaf_alpha0_ = [IOSObjectArray newArrayWithObjects:(id[]){ nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ONE_() withJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ZERO_()], nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcTnaf_MINUS_THREE_ withJavaMathBigInteger:OrgBouncycastleMathEcTnaf_MINUS_ONE_], nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcTnaf_MINUS_ONE_ withJavaMathBigInteger:OrgBouncycastleMathEcTnaf_MINUS_ONE_], nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ONE_() withJavaMathBigInteger:OrgBouncycastleMathEcTnaf_MINUS_ONE_], nil } count:9 type:OrgBouncycastleMathEcZTauElement_class_()];
    ...
    OrgBouncycastleMathEcTnaf_alpha1_ = [IOSObjectArray newArrayWithObjects:(id[]){ nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ONE_() withJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ZERO_()], nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcTnaf_MINUS_THREE_ withJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ONE_()], nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcTnaf_MINUS_ONE_ withJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ONE_()], nil, [[OrgBouncycastleMathEcZTauElement alloc] initWithJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ONE_() withJavaMathBigInteger:OrgBouncycastleMathEcECConstants_get_ONE_()], nil } count:9 type:OrgBouncycastleMathEcZTauElement_class_()];
