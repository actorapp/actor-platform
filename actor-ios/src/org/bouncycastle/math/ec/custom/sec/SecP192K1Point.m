...
- (instancetype)initWithOrgBouncycastleMathEcECCurve:(OrgBouncycastleMathEcECCurve *)curve
  ...
  return [self initOrgBouncycastleMathEcCustomSecSecP192K1PointWithOrgBouncycastleMathEcECCurve:curve withOrgBouncycastleMathEcECFieldElement:x withOrgBouncycastleMathEcECFieldElement:y withBoolean:NO];
}

- (instancetype)initOrgBouncycastleMathEcCustomSecSecP192K1PointWithOrgBouncycastleMathEcECCurve:(OrgBouncycastleMathEcECCurve *)curve
                                                         withOrgBouncycastleMathEcECFieldElement:(OrgBouncycastleMathEcECFieldElement *)x
                                                         withOrgBouncycastleMathEcECFieldElement:(OrgBouncycastleMathEcECFieldElement *)y
...
- (instancetype)initWithOrgBouncycastleMathEcECCurve:(OrgBouncycastleMathEcECCurve *)curve
             ...
             withOrgBouncycastleMathEcECFieldElement:(OrgBouncycastleMathEcECFieldElement *)y
                                         withBoolean:(jboolean)withCompression {
  return [self initOrgBouncycastleMathEcCustomSecSecP192K1PointWithOrgBouncycastleMathEcECCurve:curve withOrgBouncycastleMathEcECFieldElement:x withOrgBouncycastleMathEcECFieldElement:y withBoolean:withCompression];
}
...
- (OrgBouncycastleMathEcECPoint *)detach {
  return [[OrgBouncycastleMathEcCustomSecSecP192K1Point alloc] initWithOrgBouncycastleMathEcECCurve:nil withOrgBouncycastleMathEcECFieldElement:[self getAffineXCoord] withOrgBouncycastleMathEcECFieldElement:[self getAffineYCoord]];
}
...
- (OrgBouncycastleMathEcECPoint *)addWithOrgBouncycastleMathEcECPoint:(OrgBouncycastleMathEcECPoint *)b {
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *X1 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast(self->x_, [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]), *Y1 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast(self->y_, [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]);
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *X2 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast([b getXCoord], [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]), *Y2 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast([b getYCoord], [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]);
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Z1 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast(IOSObjectArray_Get(nil_chk(self->zs_), 0), [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]);
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Z2 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast([b getZCoordWithInt:0], [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]);
  jint c;
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *X3 = [[OrgBouncycastleMathEcCustomSecSecP192K1FieldElement alloc] initWithIntArray:t4];
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Y3 = [[OrgBouncycastleMathEcCustomSecSecP192K1FieldElement alloc] initWithIntArray:G];
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Z3 = [[OrgBouncycastleMathEcCustomSecSecP192K1FieldElement alloc] initWithIntArray:H];
  if (!Z1IsOne) {
  ...
  return [[OrgBouncycastleMathEcCustomSecSecP192K1Point alloc] initWithOrgBouncycastleMathEcECCurve:curve withOrgBouncycastleMathEcECFieldElement:X3 withOrgBouncycastleMathEcECFieldElement:Y3 withOrgBouncycastleMathEcECFieldElementArray:zs withBoolean:self->withCompression_];
}
...
- (OrgBouncycastleMathEcECPoint *)twice {
  ...
  OrgBouncycastleMathEcECCurve *curve = [self getCurve];
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Y1 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast(self->y_, [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]);
  if ([((OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) nil_chk(Y1)) isZero]) {
    return [((OrgBouncycastleMathEcECCurve *) nil_chk(curve)) getInfinity];
  }
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *X1 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast(self->x_, [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]), *Z1 = (OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *) check_class_cast(IOSObjectArray_Get(nil_chk(self->zs_), 0), [OrgBouncycastleMathEcCustomSecSecP192K1FieldElement class]);
  jint c;
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *X3 = [[OrgBouncycastleMathEcCustomSecSecP192K1FieldElement alloc] initWithIntArray:T];
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1Field_subtractWithIntArray_withIntArray_withIntArray_(X3->x_, S, X3->x_);
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Y3 = [[OrgBouncycastleMathEcCustomSecSecP192K1FieldElement alloc] initWithIntArray:S];
  ...
  OrgBouncycastleMathEcCustomSecSecP192K1FieldElement *Z3 = [[OrgBouncycastleMathEcCustomSecSecP192K1FieldElement alloc] initWithIntArray:M];
