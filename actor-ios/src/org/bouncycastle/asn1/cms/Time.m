...
- (void)copyAllFieldsTo:(OrgBouncycastleAsn1CmsTime *)other {
...
OrgBouncycastleAsn1CmsTime *OrgBouncycastleAsn1CmsTime_getInstanceWithOrgBouncycastleAsn1ASN1TaggedObject_withBoolean_(OrgBouncycastleAsn1ASN1TaggedObject *obj, jboolean explicit_) {
  OrgBouncycastleAsn1CmsTime_init();
...
OrgBouncycastleAsn1CmsTime *OrgBouncycastleAsn1CmsTime_getInstanceWithId_(id obj) {
  ...
  if (obj == nil || [obj isKindOfClass:[OrgBouncycastleAsn1CmsTime class]]) {
    return (OrgBouncycastleAsn1CmsTime *) check_class_cast(obj, [OrgBouncycastleAsn1CmsTime class]);
  }
  else if ([obj isKindOfClass:[OrgBouncycastleAsn1ASN1UTCTime class]]) {
    return [[OrgBouncycastleAsn1CmsTime alloc] initWithOrgBouncycastleAsn1ASN1Primitive:(OrgBouncycastleAsn1ASN1UTCTime *) check_class_cast(obj, [OrgBouncycastleAsn1ASN1UTCTime class])];
  }
  else if ([obj isKindOfClass:[OrgBouncycastleAsn1ASN1GeneralizedTime class]]) {
    return [[OrgBouncycastleAsn1CmsTime alloc] initWithOrgBouncycastleAsn1ASN1Primitive:(OrgBouncycastleAsn1ASN1GeneralizedTime *) check_class_cast(obj, [OrgBouncycastleAsn1ASN1GeneralizedTime class])];
  }
