...
- (instancetype)initWithNSString:(NSString *)oid {
  return [self initOrgBouncycastleAsn1X509X509NameTokenizerWithNSString:oid withChar:','];
}

- (instancetype)initOrgBouncycastleAsn1X509X509NameTokenizerWithNSString:(NSString *)oid
...
- (instancetype)initWithNSString:(NSString *)oid
                        withChar:(jchar)separator {
  return [self initOrgBouncycastleAsn1X509X509NameTokenizerWithNSString:oid withChar:separator];
}
...
- (void)copyAllFieldsTo:(OrgBouncycastleAsn1X509X509NameTokenizer *)other {
