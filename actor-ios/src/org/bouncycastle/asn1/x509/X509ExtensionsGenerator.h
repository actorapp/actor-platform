...
#ifndef _OrgBouncycastleAsn1X509X509ExtensionsGenerator_H_
#define _OrgBouncycastleAsn1X509X509ExtensionsGenerator_H_
...
@interface OrgBouncycastleAsn1X509X509ExtensionsGenerator : NSObject {
}
...
J2OBJC_EMPTY_STATIC_INIT(OrgBouncycastleAsn1X509X509ExtensionsGenerator)

CF_EXTERN_C_BEGIN
CF_EXTERN_C_END

J2OBJC_TYPE_LITERAL_HEADER(OrgBouncycastleAsn1X509X509ExtensionsGenerator)

#endif // _OrgBouncycastleAsn1X509X509ExtensionsGenerator_H_
