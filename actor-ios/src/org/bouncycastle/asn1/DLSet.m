...
//  source: /Users/ex3ndr/Develop/actor-model/actor-ios/build/java/org/bouncycastle/asn1/DLSet.java
//
...
__attribute__((unused)) static jint OrgBouncycastleAsn1DLSet_getBodyLength(OrgBouncycastleAsn1DLSet *self);
...
- (instancetype)initWithOrgBouncycastleAsn1ASN1EncodableVector:(OrgBouncycastleAsn1ASN1EncodableVector *)v {
  if (self = [super initWithOrgBouncycastleAsn1ASN1EncodableVector:v withBoolean:NO]) {
    bodyLength_ = -1;
  }
  return self;
}
...
- (instancetype)initWithOrgBouncycastleAsn1ASN1EncodableArray:(IOSObjectArray *)a {
  if (self = [super initWithOrgBouncycastleAsn1ASN1EncodableArray:a withBoolean:NO]) {
    bodyLength_ = -1;
  }
  return self;
}
...
- (jint)getBodyLength {
  return OrgBouncycastleAsn1DLSet_getBodyLength(self);
}

- (jint)encodedLength {
  jint length = OrgBouncycastleAsn1DLSet_getBodyLength(self);
...
- (void)copyAllFieldsTo:(OrgBouncycastleAsn1DLSet *)other {
...
jint OrgBouncycastleAsn1DLSet_getBodyLength(OrgBouncycastleAsn1DLSet *self) {
