...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "fromBytesWithByteArray:", "fromBytes", "Lim.actor.model.api.updates.UpdateGroupUserAdded;", 0x9, "Ljava.io.IOException;" },
    { "initWithInt:withLong:withInt:withInt:withLong:", "UpdateGroupUserAdded", NULL, 0x1, NULL },
    { "init", "UpdateGroupUserAdded", NULL, 0x1, NULL },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "HEADER_", NULL, 0x19, "I", NULL, .constantValue.asInt = ImActorModelApiUpdatesUpdateGroupUserAdded_HEADER },
  ...
  static const J2ObjcClassInfo _ImActorModelApiUpdatesUpdateGroupUserAdded = { 1, "UpdateGroupUserAdded", "im.actor.model.api.updates", NULL, 0x1, 11, methods, 6, fields, 0, NULL};
  return &_ImActorModelApiUpdatesUpdateGroupUserAdded;
}
...
ImActorModelApiUpdatesUpdateGroupUserAdded *ImActorModelApiUpdatesUpdateGroupUserAdded_fromBytesWithByteArray_(IOSByteArray *data) {
  ...
  return ((ImActorModelApiUpdatesUpdateGroupUserAdded *) ImActorModelDroidkitBserBser_parseWithImActorModelDroidkitBserBserObject_withByteArray_([[[ImActorModelApiUpdatesUpdateGroupUserAdded alloc] init] autorelease], data));
}
