...
ImActorModelApiUpdatesUpdateUserContactAdded *ImActorModelApiUpdatesUpdateUserContactAdded_fromBytesWithByteArray_(IOSByteArray *data) {
  ...
  return ((ImActorModelApiUpdatesUpdateUserContactAdded *) BSBser_parseWithBSBserObject_withByteArray_([[ImActorModelApiUpdatesUpdateUserContactAdded alloc] init], data));
}
