...
- (void)parseWithComDroidkitBserBserValues:(ComDroidkitBserBserValues *)values {
  self->addedUid_ = [((ComDroidkitBserBserValues *) nil_chk(values)) getIntWithInt:1];
}

- (void)serializeWithComDroidkitBserBserWriter:(ComDroidkitBserBserWriter *)writer {
  [((ComDroidkitBserBserWriter *) nil_chk(writer)) writeIntWithInt:1 withInt:self->addedUid_];
}
