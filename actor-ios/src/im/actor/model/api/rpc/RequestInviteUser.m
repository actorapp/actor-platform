...
- (void)parseWithComDroidkitBserBserValues:(ComDroidkitBserBserValues *)values {
  ImActorModelApiRpcRequestInviteUser_set_groupPeer_(self, [((ComDroidkitBserBserValues *) nil_chk(values)) getObjWithInt:1 withIOSClass:ImActorModelApiGroupOutPeer_class_()]);
  self->rid_ = [values getLongWithInt:4];
  ImActorModelApiRpcRequestInviteUser_set_user_(self, [values getObjWithInt:3 withIOSClass:ImActorModelApiUserOutPeer_class_()]);
}
...
ImActorModelApiRpcRequestInviteUser *ImActorModelApiRpcRequestInviteUser_fromBytesWithByteArray_(IOSByteArray *data) {
  ...
  return ((ImActorModelApiRpcRequestInviteUser *) ComDroidkitBserBser_parseWithIOSClass_withByteArray_(ImActorModelApiRpcRequestInviteUser_class_(), data));
}
