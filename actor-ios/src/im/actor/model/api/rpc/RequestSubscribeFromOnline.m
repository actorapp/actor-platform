...
- (void)parseWithImActorModelDroidkitBserBserValues:(ImActorModelDroidkitBserBserValues *)values {
  ...
  ImActorModelApiRpcRequestSubscribeFromOnline_set_users_(self, [values getRepeatedObjWithInt:1 withJavaUtilList:_users]);
}
...
ImActorModelApiRpcRequestSubscribeFromOnline *ImActorModelApiRpcRequestSubscribeFromOnline_fromBytesWithByteArray_(IOSByteArray *data) {
  ...
  return ((ImActorModelApiRpcRequestSubscribeFromOnline *) ImActorModelDroidkitBserBser_parseWithImActorModelDroidkitBserBserObject_withByteArray_([[[ImActorModelApiRpcRequestSubscribeFromOnline alloc] init] autorelease], data));
}
