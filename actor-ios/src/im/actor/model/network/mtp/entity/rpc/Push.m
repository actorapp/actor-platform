...
- (void)readBodyWithJavaIoInputStream:(JavaIoInputStream *)bs {
  ...
  MTPush_set_body_(self, AMStreamingUtils_readProtoBytesWithJavaIoInputStream_(bs));
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithJavaIoInputStream:", "Push", NULL, 0x1, "Ljava.io.IOException;" },
  ...
  static const J2ObjcClassInfo _MTPush = { 1, "Push", "im.actor.model.network.mtp.entity.rpc", NULL, 0x1, 7, methods, 2, fields, 0, NULL};
  return &_MTPush;
}
