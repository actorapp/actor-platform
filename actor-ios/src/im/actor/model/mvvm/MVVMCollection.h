...
- (id)createNewWithAMKeyValueItem:(id<AMKeyValueItem>)raw;

- (IOSByteArray *)serializeWithAMKeyValueItem:(id<AMKeyValueItem>)raw;
...
@interface AMMVVMCollection_ProxyKeyValueEngine : NSObject < AMKeyValueEngine > {
}
