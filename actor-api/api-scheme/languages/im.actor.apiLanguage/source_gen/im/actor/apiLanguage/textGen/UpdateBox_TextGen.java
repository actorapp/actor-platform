...
public class UpdateBox_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    this.append(",");
    this.appendNewLine();
    if (SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0xb2770c7e79e78e4L, 0xabaabdc394f36beL, "docs")) != null && SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0xb2770c7e79e78e4L, 0xabaabdc394f36beL, "docs")).size() > 0) {
      this.append("\"doc\":[");
      this.appendNewLine();
      Boolean isFirstAttribute = true;
      for (SNode doc : ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0xb2770c7e79e78e4L, 0xabaabdc394f36beL, "docs")))) {
        if (!(isFirstAttribute)) {
          this.append(",");
        } else {
