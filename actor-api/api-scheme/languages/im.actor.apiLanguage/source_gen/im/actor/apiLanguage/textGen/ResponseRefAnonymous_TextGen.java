...
public class ResponseRefAnonymous_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    this.append(", ");
    if (SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b6900bdaL, 0x48e9a7e12ae333ccL, "docs")) != null && SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b6900bdaL, 0x48e9a7e12ae333ccL, "docs")).size() > 0) {
      this.append("\"doc\":[");
      this.appendNewLine();
      Boolean isFirstAttribute = true;
      for (SNode doc : ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b6900bdaL, 0x48e9a7e12ae333ccL, "docs")))) {
        if (!(isFirstAttribute)) {
          this.append(",");
        } else {
