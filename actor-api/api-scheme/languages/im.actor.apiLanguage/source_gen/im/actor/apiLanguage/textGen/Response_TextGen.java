...
public class Response_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    this.append("{\"type\":\"response\",\"content\":{");
    this.appendNewLine();
    this.append("\"name\":\"");
    ...
    this.append(",");
    this.appendNewLine();
    if (SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b68f591bL, 0xabaabdc394f3ae2L, "docs")) != null && SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b68f591bL, 0xabaabdc394f3ae2L, "docs")).size() > 0) {
      this.append("\"doc\":[");
      this.appendNewLine();
      Boolean isFirstAttribute = true;
      for (SNode doc : ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b68f591bL, 0xabaabdc394f3ae2L, "docs")))) {
        if (!(isFirstAttribute)) {
          this.append(",");
        } else {
