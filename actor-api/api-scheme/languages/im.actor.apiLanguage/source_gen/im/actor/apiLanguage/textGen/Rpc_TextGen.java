...
public class Rpc_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    ...
    appendNode(SLinkOperations.getTarget(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b68f84bcL, 0x20977a66b68f99bcL, "response")));
    this.append(",");
    this.appendNewLine();
    if (SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b68f84bcL, 0x2aa6bc7b463bc1fdL, "docs")) != null && SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b68f84bcL, 0x2aa6bc7b463bc1fdL, "docs")).size() > 0) {
      this.append("\"doc\":[");
      this.appendNewLine();
      Boolean isFirstAttribute = true;
      for (SNode doc : ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x20977a66b68f84bcL, 0x2aa6bc7b463bc1fdL, "docs")))) {
        if (!(isFirstAttribute)) {
          this.append(",");
        } else {
        ...
        if (SNodeOperations.isInstanceOf(doc, MetaAdapterFactory.getConcept(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0xabaabdc394e4634L, "im.actor.apiLanguage.structure.StructDocComment"))) {
          ...
          this.append(SPropertyOperations.getString(docParameter, MetaAdapterFactory.getProperty(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0xabaabdc394ebffaL, 0xabaabdc394ec61eL, "description")).trim());
          this.append("\"}");
        }
      }
      this.append("],");
