...
public class Update_TextGen extends SNodeTextGen {
  public void doGenerateText(SNode node) {
    this.append("{\"type\":\"update\",\"content\":{");
    this.appendNewLine();
    this.append("\"name\":\"");
    ...
    this.append(",");
    this.appendNewLine();
    if (SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x4114dc2d7272a279L, 0xabaabdc394f329eL, "docs")) != null && SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x4114dc2d7272a279L, 0xabaabdc394f329eL, "docs")).size() > 0) {
      this.append("\"doc\":[");
      this.appendNewLine();
      Boolean isFirstAttribute = true;
      for (SNode doc : ListSequence.fromList(SLinkOperations.getChildren(node, MetaAdapterFactory.getContainmentLink(0x77fdf769432b4edeL, 0x8171050f8dee73fcL, 0x4114dc2d7272a279L, 0xabaabdc394f329eL, "docs")))) {
        if (!(isFirstAttribute)) {
          this.append(",");
        } else {
