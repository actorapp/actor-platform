...
private[group] object GroupOfficeActor {
  ...
  ActorSerializer.register(20013, classOf[GroupCommands.UpdateTitle])
  ActorSerializer.register(20014, classOf[GroupCommands.ChangeGroupTopic])
  ActorSerializer.register(20015, classOf[GroupCommands.ChangeGroupTopicAck])
  ActorSerializer.register(20016, classOf[GroupCommands.ChangeGroupAbout])
  ActorSerializer.register(20017, classOf[GroupCommands.ChangeGroupAboutAck])
  ActorSerializer.register(20018, classOf[GroupCommands.MakeUserAdmin])
