...
final class UnregisteredEmailContactTable(tag: Tag) extends UnregisteredContactBase[models.UnregisteredEmailContact](tag, "unregistered_email_contacts") with InheritingTable {
