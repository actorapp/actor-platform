...
object Message {
  def banner(advertUrl: String, fileId: Long, fileAccessHash: Long, fileSize: Long) = {
    Message(BannerData.dataType, BannerData(advertUrl, Image(fileId, fileAccessHash, fileSize)))
  }
}
