...
if [ "$#" -ne 0 ]; then
    ...
    "./gradlew" run  "-PappArgs=['$SCRIPT_DIR/app.conf', '$1', '$SCRIPT_DIR/app-ios/Actor/Supporting Files/app.json', 'ios']"
    ...
    "./gradlew" run  "-PappArgs=['$SCRIPT_DIR/app.conf', '$SCRIPT_DIR/app-ios/Actor/Supporting Files/app.json', 'ios']"
