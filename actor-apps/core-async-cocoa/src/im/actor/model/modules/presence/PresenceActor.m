...
void ImActorModelModulesPresencePresenceActor_onUserOnlineWithInt_withLong_(ImActorModelModulesPresencePresenceActor *self, jint uid, jlong updateDate) {
  ...
  [((DKActorRef *) nil_chk([self self__])) sendOnceWithId:new_ImActorModelModulesPresencePresenceActor_UserLastSeen_initWithInt_withLong_withLong_(uid, updateDate + ImActorModelModulesPresencePresenceActor_ONLINE_TIMEOUT, updateDate + ImActorModelModulesPresencePresenceActor_ONLINE_TIMEOUT) withLong:ImActorModelModulesPresencePresenceActor_ONLINE_TIMEOUT];
}
