...
emoji.img_sets = {
  'apple': {
    ...
    'sheet': Path.toEmoji + '/sheet_apple_32.png',
    'mask': 1
  },
  'google': {
    'path': Path.toEmoji + '/img-google-64/',
    'sheet': Path.toEmoji + '/sheet_google_32.png',
    'mask': 2
  },
  'twitter': {
    'path': Path.toEmoji + '/img-twitter-64/',
    'sheet': Path.toEmoji + '/sheet_twitter_32.png',
    'mask': 4
  },
  'emojione': {
    'path': Path.toEmoji + '/img-emojione-64/',
    'sheet': Path.toEmoji + '/sheet_emojione_32.png',
    'mask': 8
  }
};
