...
class SettingsPrivacyViewController: AATableViewController {
    ...
    private var data: UAGrouppedTableData!
    ...
    override func viewDidLoad() {
        ...
        data = UAGrouppedTableData(tableView: tableView)
        ...
        data.addSection(true)
            .addCustomCells(44, countClosure: { () -> Int in
                    ...
                    let cell = tableView.dequeueReusableCellWithIdentifier(UABaseTableData.ReuseCommonCell, forIndexPath: indexPath) as! CommonCell
