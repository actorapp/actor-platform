...
class UATableData {
    ...
    init(tableView: UITableView) {
        ...
        self.tableView.registerClass(CommonCell.self, forCellReuseIdentifier: UATableData.ReuseCommonCell)
        self.tableView.registerClass(TextCell.self, forCellReuseIdentifier: UATableData.ReuseTextCell)
        self.tableView.registerClass(TitledCell.self, forCellReuseIdentifier: UATableData.ReuseTitledCell)
...
class UATextCellRegion: UASingleCellRegion {
    ...
    override func buildCell(tableView: UITableView, index: Int, indexPath: NSIndexPath) -> UITableViewCell {
        let res = tableView.dequeueReusableCellWithIdentifier(UATableData.ReuseTextCell, forIndexPath: indexPath) as! TextCell
...
class UATitledCellRegion: UASingleCellRegion {
    ...
    override func buildCell(tableView: UITableView, index: Int, indexPath: NSIndexPath) -> UITableViewCell {
        let res = tableView.dequeueReusableCellWithIdentifier(UATableData.ReuseTitledCell, forIndexPath: indexPath) as! TitledCell
        res.setTitle(title, content: text)
        return res
    }
...
class UACommonCellRegion : UARegion {
    ...
    override func buildCell(tableView: UITableView, index: Int, indexPath: NSIndexPath) -> UITableViewCell {
        let res = tableView.dequeueReusableCellWithIdentifier(UATableData.ReuseCommonCell, forIndexPath: indexPath) as! CommonCell
...
private class AMBaseTableDelegate: NSObject, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate {
    ...
    private let data: UATableData
    
    init(data: UATableData) {
        self.data = data
    }
...
private class RegionSearchResult {
    let region: UARegion
    let index: Int
