...
//    }
//    
//    func onNotificationWithMessenger(messenger: ACMessenger!, withTopNotifications topNotifications: JavaUtilList!, withMessagesCount messagesCount: jint, withConversationsCount conversationsCount: jint, withSilentUpdate silentUpdate: Bool, withIsInApp isInApp: Bool) {
//        if (silentUpdate) {
//            return
//        }
//        
