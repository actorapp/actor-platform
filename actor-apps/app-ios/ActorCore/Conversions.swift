...
class CRC32 {
    ...
    private static let table:[UInt32] = [0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419, 0x706af48f, 0xe963a535, 0x9e6495a3,
    ...
    class func crc32(message:NSData) -> NSData {
