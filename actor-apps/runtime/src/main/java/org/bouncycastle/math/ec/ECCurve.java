...
public abstract class ECCurve
{
    ...
    /**
     * @deprecated per-point compression property will be removed, use {@link #validatePoint(java.math.BigInteger, java.math.BigInteger)}
    ...
    /**
     * @deprecated per-point compression property will be removed, use {@link #createPoint(java.math.BigInteger, java.math.BigInteger)}
     * and refer {@link ECPoint#getEncoded(boolean)}
     */
    ...
    public PreCompInfo getPreCompInfo(ECPoint point, String name)
    {
        ...
        synchronized (point)
        {
            HashMap table = point.preCompTable;
