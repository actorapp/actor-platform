package im.actor.android.state;

import im.actor.android.AndroidBaseMessenger;
import im.actor.core.droidkit.actors.Actor;
...
public class AppStateActor extends Actor {
    ...
    private final AndroidBaseMessenger messenger;

    private boolean isAppOpen = false;
    private boolean isScreenVisible = true;
    private int activityCount = 0;

    public AppStateActor(AndroidBaseMessenger messenger) {
