...
//  source: /Users/ex3ndr/Develop/actor-proprietary/actor-apps/core/src/main/java/im/actor/model/viewmodel/UserVM.java
//
...
#define AMUserVM_PRESENCE_UPDATE_DELAY 60000LL
...
@interface AMUserVM () {
 @public
  ...
  AMAbsTimerCompat *presenceTimer_;
...
J2OBJC_FIELD_SETTER(AMUserVM, presenceTimer_, AMAbsTimerCompat *)
J2OBJC_FIELD_SETTER(AMUserVM, phones_, AMUserPhoneValueModel *)
J2OBJC_FIELD_SETTER(AMUserVM, listeners_, JavaUtilArrayList *)

J2OBJC_STATIC_FIELD_GETTER(AMUserVM, PRESENCE_UPDATE_DELAY, jlong)
...
@interface AMUserVM_$2 : NSObject < JavaLangRunnable > {
 @public
  AMUserVM *this$0_;
}
...
J2OBJC_EMPTY_STATIC_INIT(AMUserVM_$2)

J2OBJC_FIELD_SETTER(AMUserVM_$2, this$0_, AMUserVM *)

__attribute__((unused)) static void AMUserVM_$2_initWithAMUserVM_(AMUserVM_$2 *self, AMUserVM *outer$);

__attribute__((unused)) static AMUserVM_$2 *new_AMUserVM_$2_initWithAMUserVM_(AMUserVM *outer$) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(AMUserVM_$2)
...
void AMUserVM_initWithAMUser_withImActorModelModulesModules_(AMUserVM *self, AMUser *user, ImActorModelModulesModules *modules) {
  ...
  self->presenceTimer_ = DKEnvironment_createTimerWithJavaLangRunnable_(new_AMUserVM_$1_initWithAMUserVM_(self));
  [((AMAbsTimerCompat *) nil_chk(self->presenceTimer_)) scheduleWithLong:AMUserVM_PRESENCE_UPDATE_DELAY];
}
...
void AMUserVM_notifyChange(AMUserVM *self) {
  [((id<AMMainThreadProvider>) nil_chk(AMMVVMEngine_getMainThreadProvider())) postToMainThreadWithRunnable:new_AMUserVM_$2_initWithAMUserVM_(self)];
}
...
- (void)run {
  [((AMUserPresenceValueModel *) nil_chk(this$0_->presence_)) forceNotify];
  [((AMAbsTimerCompat *) nil_chk(this$0_->presenceTimer_)) scheduleWithLong:AMUserVM_PRESENCE_UPDATE_DELAY];
}
...
- (instancetype)initWithAMUserVM:(AMUserVM *)outer$ {
  AMUserVM_$2_initWithAMUserVM_(self, outer$);
  return self;
}

@end

void AMUserVM_$2_initWithAMUserVM_(AMUserVM_$2 *self, AMUserVM *outer$) {
  self->this$0_ = outer$;
  (void) NSObject_init(self);
}

AMUserVM_$2 *new_AMUserVM_$2_initWithAMUserVM_(AMUserVM *outer$) {
  AMUserVM_$2 *self = [AMUserVM_$2 alloc];
  AMUserVM_$2_initWithAMUserVM_(self, outer$);
  return self;
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(AMUserVM_$2)
