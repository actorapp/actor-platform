...
//  source: /Users/ex3ndr/Develop/actor-proprietary/actor-apps/core/src/main/java/im/actor/model/modules/Messages.java
//
...
- (void)run {
  ...
  self->plainReadActor_ = [((DKActorSystem *) nil_chk(DKActorSystem_system())) actorOfWithDKProps:[((DKProps *) nil_chk(DKProps_createWithIOSClass_withDKActorCreator_(ImActorModelModulesMessagesCursorReaderActor_class_(), new_ImActorModelModulesMessages_$4_initWithImActorModelModulesMessages_(self)))) changeDispatcherWithNSString:@"heavy"] withNSString:@"actor/plain/read"];
  self->plainReceiverActor_ = [((DKActorSystem *) nil_chk(DKActorSystem_system())) actorOfWithDKProps:[((DKProps *) nil_chk(DKProps_createWithIOSClass_withDKActorCreator_(ImActorModelModulesMessagesCursorReceiverActor_class_(), new_ImActorModelModulesMessages_$5_initWithImActorModelModulesMessages_(self)))) changeDispatcherWithNSString:@"heavy"] withNSString:@"actor/plain/receive"];
...
- (void)sendMessageWithAMPeer:(AMPeer *)peer
  ...
  [((DKActorRef *) nil_chk(sendMessageActor_)) sendWithId:new_ImActorModelModulesMessagesSenderActor_SendText_initWithAMPeer_withNSString_withNSString_withJavaUtilArrayList_withBoolean_(peer, message, markDownText, mentions, autoDetect)];
}
