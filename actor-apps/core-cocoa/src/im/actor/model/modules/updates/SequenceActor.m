...
//  source: /Users/ex3ndr/Develop/actor-proprietary/actor-apps/core/src/main/java/im/actor/model/modules/updates/SequenceActor.java
//
...
__attribute__((unused)) static void ImActorModelModulesUpdatesSequenceActor_onUpdateStarted(ImActorModelModulesUpdatesSequenceActor *self);

__attribute__((unused)) static void ImActorModelModulesUpdatesSequenceActor_onUpdateEnded(ImActorModelModulesUpdatesSequenceActor *self);
...
- (void)onUpdateStarted {
  ImActorModelModulesUpdatesSequenceActor_onUpdateStarted(self);
}

- (void)onUpdateEnded {
  ImActorModelModulesUpdatesSequenceActor_onUpdateEnded(self);
}
...
void ImActorModelModulesUpdatesSequenceActor_onUpdateStarted(ImActorModelModulesUpdatesSequenceActor *self) {
  [((AMValueModel *) nil_chk([((AMAppStateVM *) nil_chk([((ImActorModelModulesAppStateModule *) nil_chk([((ImActorModelModulesModules *) nil_chk([self modules])) getAppStateModule])) getAppStateVM])) getIsSyncing])) changeWithValue:JavaLangBoolean_valueOfWithBoolean_(YES)];
}

void ImActorModelModulesUpdatesSequenceActor_onUpdateEnded(ImActorModelModulesUpdatesSequenceActor *self) {
  [((AMValueModel *) nil_chk([((AMAppStateVM *) nil_chk([((ImActorModelModulesAppStateModule *) nil_chk([((ImActorModelModulesModules *) nil_chk([self modules])) getAppStateModule])) getAppStateVM])) getIsSyncing])) changeWithValue:JavaLangBoolean_valueOfWithBoolean_(NO)];
}
...
- (void)onResult:(APResponseGetDifference *)response {
  ...
  if ([response needMore]) {
    ...
    ImActorModelModulesUpdatesSequenceActor_onUpdateEnded(this$0_);
  }
}
