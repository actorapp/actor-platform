...
import im.actor.core.modules.messages.entity.PendingMessage;
import im.actor.core.modules.messages.entity.PendingMessagesStorage;
...
public class SenderActor extends ModuleActor {
    ...
    public void doSendText(@NotNull Peer peer, @NotNull String text,
        ...
        modules().getMessagesModule().getConversationActor(peer).send(message);
    ...
    private void onFileUploaded(long rid, FileReference fileReference) {
        ...
        modules().getMessagesModule().getConversationActor(msg.getPeer()).send(new ConversationActor.MessageContentUpdated(msg.getRid(), nContent));
    ...
    private void onError(Peer peer, long rid) {
        ...
        savePending();
        modules().getMessagesModule().getConversationActor(peer).send(new ConversationActor.MessageError(rid));
    }
