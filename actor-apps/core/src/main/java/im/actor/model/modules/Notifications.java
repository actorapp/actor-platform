...
public class Notifications extends BaseModule {
    ...
    public void onInMessage(Peer peer, int sender, long sortDate, ContentDescription contentDescription, boolean hasCurrentUserMention, boolean isAlreadyRead) {
        notificationsActor.send(new NotificationsActor.NewMessage(peer, sender, sortDate, contentDescription, hasCurrentUserMention, isAlreadyRead));
    }
