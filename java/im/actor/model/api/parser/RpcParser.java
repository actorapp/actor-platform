...
public class RpcParser extends BaseParser<RpcScope> {
    ...
    public RpcScope read(int type, byte[] payload) throws IOException {
        switch(type) {
            ...
            case 97: return RequestrequestFileUploadUrl.fromBytes(payload);
            case 122: return RequestrequestFileUploadCompleted.fromBytes(payload);
            case 142: return RequestrequestFileUploadPart.fromBytes(payload);
            ...
            case 141: return ResponserequestFileUploadPart.fromBytes(payload);
