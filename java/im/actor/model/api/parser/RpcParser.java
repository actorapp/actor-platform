...
public class RpcParser extends BaseParser<RpcScope> {
    ...
    public RpcScope read(int type, byte[] payload) throws IOException {
        switch(type) {
            ...
            case 182: return RequestGetGroupToken.fromBytes(payload);
            case 184: return RequestRevokeGroupToken.fromBytes(payload);
            ...
            case 183: return ResponseGroupToken.fromBytes(payload);
